...
```sh
gh attestation verify FILE --repo faratech/linefeed --predicate-type https://faratech.dev/attestations/windows-release-verification/v1 --signer-workflow faratech/linefeed/.github/workflows/attest-existing-release.yml
```
